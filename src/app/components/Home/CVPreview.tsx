...
const CVPreview: React.FC<CVPreviewProps> = ({
  ...
  const workExperiences = [
    ...
    },
    {
      ...
      period: "2018 - 2020",
      responsibilities: [t("cv_preview.experience.junior.responsibility1")],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={itemVariants}
        className="flex flex-wrap gap-3 p-4 bg-gray-50 border-b border-gray-200 text-sm"
      >
